...
/************************************************************
 * search:  Prompts the user to enter a part number, than   *
 ...
 *          exist; otherwise, propmpts the user to enter    *
...
void print(void)
{
  ...
  for(int i = 0; i < num_parts; i++)
  {
    printf("%7d       %-25s%11d\n", inventory[sortarray[i]].number, inventory[sortarray[i]].name, inventory[sortarray[i]].on_hand);
  }
}